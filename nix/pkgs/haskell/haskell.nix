...
############################################################################
{ haskell-nix, stdenv, R, rPackages, z3, deferPluginErrors, agdaWithStdlib
, buildPackages, gitignore-nix, compiler-nix-name, checkMaterialization
...
let
  project = haskell-nix.project {
    ...
    sha256map = {
      ...
      "https://github.com/input-output-hk/plutus.git"."4551bba244a2f3ff890c4d2fd12a105692126d8d" =
        "sha256:0s3ycmfrpgylxjqk51rkdnj7acp7xq42zmahykbrdmvgmqfllg4f";
      ...
      "https://github.com/input-output-hk/cardano-node.git"."f3ef4ed72894499160f2330b91572a159005c148" =
        "sha256:1mp8ih6kmq4j354mgjgrxlssv7jbk5zz1j3nyqg43ascql4d0fvq";
      ...
      "https://github.com/Liqwid-Labs/plutus-extra.git"."7d933c0189d84b77888fc6b598f8eaec384c8df0" =
        "0aiv6cdh9q548rn13fhhsdg7amnbrcf5bq3hgliyfmc72fz6r474";
    };
    ...
    modules = [{
      packages = {
        eventful-sql-common = {
          ...
          ghcOptions = [
            "-XDerivingStrategies -XStandaloneDeriving -XUndecidableInstances -XDataKinds -XFlexibleInstances -XMultiParamTypeClasses"
          ];
          doHaddock = false;
        };

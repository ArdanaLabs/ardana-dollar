    ...
    treasuryTrace = do
      ...
      case orefs of
        ...
        ((oref, _pkh) : _) -> do
          ...
          callEndpoint @"initUpgrade" cTreasuryUserId (NewContract (Ledger.ValidatorHash "abcd"))
...
--     dataChecker :: TreasuryState -> Bool
--     dataChecker TreasuryState {costCenters = cc} =
...
upgrade =
  ...
  where
    ...
    -- dataChecker :: TreasuryState -> Bool
    -- dataChecker TreasuryState {currentContract = cc} = cc == nc

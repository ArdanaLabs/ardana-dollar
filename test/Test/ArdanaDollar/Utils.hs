...
vaultUnitTests =
  testGroup
    ...
    [ let exr = 16283 R.% 1_000_000
          coll = 1_000_000
          debt = 3000
       in -- https://www.youtube.com/watch?v=GjMI_1zkBzo&t=455s
          testGroup
            "1"
            [ testCase "collaterizationRatio" $
                assertEqual
                  ""
                  (Finite (16283 R.% 3000))
    ...
    , let exr = 16283 R.% 1_000_000
          coll = 1_000_000
          debt = 6000
       in -- https://www.youtube.com/watch?v=GjMI_1zkBzo&t=540s
          testGroup
            "2"
            [ testCase "collaterizationRatio" $
                assertEqual
    ...
    , let exr = 16283 R.% 1_000_000
          coll = 1_300_000
          debt = 6000
       in -- https://www.youtube.com/watch?v=GjMI_1zkBzo&t=935s
          testGroup
            "3"
            [ testCase "collaterizationRatio" $
                assertEqual
                  ""
                  (Finite (211679 R.% 60000))
                  (collaterizationRatio exr coll debt)
            , testCase "maxDebtAllowed" $
                assertEqual
                  ""
    ...
    , let exr = 16283 R.% 1_000_000
          coll = 1_300_000
          debt = 7800
       in -- https://www.youtube.com/watch?v=GjMI_1zkBzo&t=960s
          testGroup
            "4"
            [ testCase "collaterizationRatio" $
                assertEqual
    ...
    , let exr = 2162 R.% 100_000_000
          coll = 200_000_000
          debt = 2000
       in -- https://www.youtube.com/watch?v=GjMI_1zkBzo&t=1030s
          testGroup
            "5"
            [ testCase "collaterizationRatio" $
                assertEqual
    ...
    , let exr = 2162 R.% 100_000_000
          coll = 200_000_000
          debt = 0
       in -- https://www.youtube.com/watch?v=GjMI_1zkBzo&t=1060s
          testGroup
            "6"
            [ testCase "collaterizationRatio" $
                assertEqual
    ...
    , let exr = 2162 R.% 100_000_000
          coll = 0
          debt = 0
       in -- https://www.youtube.com/watch?v=GjMI_1zkBzo&t=1075s
          testGroup
            "7"
            [ testCase "collaterizationRatio" $
                assertEqual
